...
<body>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="https://drive.google.com/file/d/keerthanaresume.docxusp=sharing" target="_blank" class="download-button">Download  HTML  editor</a>
        </center>
        </div>
